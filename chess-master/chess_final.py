...
def main():
	...
	txt.setSize(50)
	txt.draw(win)
	# img = Image(Point(500,300), "/Users/shubhamgupta/Downloads/chess-master/start.gif")
	# img.draw(win)
...
def getAvailable(i,j,x1,y1,x2,y2):
	global isWhiteCheck
	global isblackCheck
